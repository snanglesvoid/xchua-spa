...
export class FrontPageImage extends Model {
    ...
    public get linkUrl() { return this.model.linkUrl || '#' }
    public get textColor() { return this.model.textColor }
    public get textPlacement() { return this.model.textPlacement }
    public get listPriority() { return this.model.listPriority }

    translate(language: Language) {
        this._title = this.model.title[language] || this.model.title.english
        this._subtitle = this.model.subtitle[language] || this.model.subtitle.english || ''
        this._caption = this.model.caption[language] || this.model.caption.english || ''
    }
