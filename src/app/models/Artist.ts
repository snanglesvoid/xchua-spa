...
export class Artwork extends Model {
    constructor(api: ApiService, private model: ArtworkModel) {
      ...
      this._description = this.model.description ? this.model.description.english || '' : 'NULL'
      this._artist = typeof model.artist === 'string'
        ? model.artist : model.artist
        ? new Artist(api, model.artist)
        : null
      this._artistName = this.model.artistName ? this.model.artistName.english || '' : ''
    ...
    public translate(language: Language) {
      ...
      this._description = this.model.description ? this.model.description[language] || this.model.description.english || '' : "NULL"
      this._artistName = this.model.artistName ? this.model.artistName[language] || this.model.artistName.english || '' : 'NULL'
