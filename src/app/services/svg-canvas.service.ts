...
export class CanvasLine extends CanvasElement {
  ...
  private setStyle() {
    this.line.setAttribute(
      "style",
      `stroke:${this._stroke}; stroke-width:${this._strokeWidth}; stroke-linecap:${this._strokeLinecap}`
    );
  }
}
...
export class CanvasBezier extends CanvasElement {
  ...
  private setStyle() {
    this.path.setAttribute(
      "style",
      `stroke:${this._stroke};stroke-width:${this._strokeWidth};stroke-linecap:${this._strokeLinecap};fill:${this._fill}`
    );
  }
}
