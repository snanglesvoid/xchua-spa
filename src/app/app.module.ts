...
const appRoutes: Routes = [
  ...
  {
    path: 'viewing-rooms',
    component: ViewingRoomsComponent,
    data: {animation: 'ViewingRoomsPage'},
  },
  {
    path: 'viewing-rooms/:slug',
    component: ViewingRoomComponent,
    data: {animation: 'ViewingRoomPage'},
  },
...
@NgModule({
  declarations: [
    ...
    ViewingRoomsComponent,
    ViewingRoomComponent,
    ContentBlockComponent,
    TitleImageBlockComponent,
    ArtworkDisplayBlockComponent,
